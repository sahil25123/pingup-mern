  ...
  return (
    <div key={user._id} className='p-4 pt-6 flex flex-col justify-between w-72 shadow border border-gray-200 rounded-md'>
        <div className='text-center'>
            <img src={user.profil_picture} className='aspect-square object-cover rounded-full w-16 shadow-md mx-auto' alt="" />
        ...
        <div className='flex mt-4 gap-2'>
            ...
            <button onClick={handleConnection} className='flex items-center justify-center w-16 border text-slate-800 group rounded-md cursor-pointer active:scale-95 transition'>
                {
